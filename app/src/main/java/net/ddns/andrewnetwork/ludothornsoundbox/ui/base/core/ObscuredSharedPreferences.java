...
public class ObscuredSharedPreferences implements SharedPreferences {
    ...
    // your app.
    private static char[] SEKRIT = {'b','4','q','1','q','8','8','l','m','a','n','2','g','0','7','r','9','n','9','a'} ;
    ...
    public ObscuredSharedPreferences(Context context, SharedPreferences delegate, String secret) {
        if(secret != null)
            SEKRIT = secret.toCharArray();
        this.delegate = delegate;
        this.context = context;
    }
