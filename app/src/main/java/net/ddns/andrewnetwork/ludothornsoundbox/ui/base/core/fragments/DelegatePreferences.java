...
class DelegatePreferences implements ICoreFragment, FragmentLifeCycleListener {

    private CorePreferencesFragment mFragment;

    DelegatePreferences(CorePreferencesFragment fragment) {
        mFragment = fragment;
    }
