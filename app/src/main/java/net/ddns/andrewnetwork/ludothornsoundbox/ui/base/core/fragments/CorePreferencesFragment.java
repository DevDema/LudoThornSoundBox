 ...
 * @date: 29/10/2018
 */
public abstract class CorePreferencesFragment extends PreferenceFragmentCompat implements ICoreFragment {
    ...
    private DelegatePreferences mDelegate = new DelegatePreferences(this);
